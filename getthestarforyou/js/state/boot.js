"use strict";
window.getTheStarForYou.state.boot = {
	preload: function(){
		// set world size
	...
	create: function(){
		// add all game states
		for(var stateName in window.getTheStarForYou.state){
			this.game.state.add(stateName, window.getTheStarForYou.state[stateName]);
		}
